...
return [
    ...
    */
    ...
    'title' => 'Fosforera Centroamericana',
    'title_prefix' => '',
    'title_postfix' => '',
    ...
    */
    ...
    'menu' => [
        [
            'text'    => 'Administración Tablas',
            'icon'    => 'fas fa-fw fa-circle',
            'submenu' => [
                  [
                    'text'        => 'Proveedores',
                    'url'         => '/proveedor',
                    'icon'        => 'far fa-f fa-circle',
                ],
                [
                    'text'        => 'Clientes',
                    'url'         => '/cliente',
        ...
        [
            ...
            'submenu' => [
                [
                    'text'        => 'Orden de Pedido (cliente)',
                    'url'         => '/pedido',
                    'icon'        => 'far fa-f fa-circle',
                ],
                [
                    'text'        => 'Orden de Compra(proveedor)',
                    'url'         => '/compra',
                    'icon'        => 'far fa-f fa-circle',
                ],
                [
        ...
        [
            ...
            'submenu' => [
                [
                    'text'        => 'Respaldo y Restablecer DB',
                    'url'         => 'respaldo/',
                    'icon'        => 'far fa-f fa-circle',
                ],
                [

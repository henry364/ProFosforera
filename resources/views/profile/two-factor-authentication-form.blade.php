<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div>
                <img src="{{ asset('img/google-authenticator.png') }}">
            </div>
            ...
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        {{ __('La autenticación de dos factores ahora está habilitada. Escanee el siguiente código QR usando la aplicación de google authenticator de su teléfono.') }}
                    </p>
                </div>

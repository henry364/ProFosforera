...
<div class="col-lg-12 left">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
            <div class="form-group has-primary">
            <br>
            <a href="producto/tabla"><input type= "submit" value="Registrar Producto" class="btn btn-danger"></a>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
            <div class="form-group has-primary">
            <x-jet-label for="precio_producto" value="{{ __('Producto en Existencia') }}" />
...
<div class="col-lg-12 left">
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
            <div class="form-group has-primary">
            <x-jet-label for="descripcion_producto" value="{{ __('Venta al Contado o al Crédito') }}" />
            <select name="cod_tipo_producto" class="form-control" maxlength="50">
                   <option value="--Seleccione">--Seleccione</option>
             </select>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
            <div class="form-group has-primary">
            <x-jet-label for="precio_producto" value="{{ __('Precio del Producto') }}" />
            <x-jet-input id="precio_producto" class="form-control" type="text" name="precio_producto" maxlength="50" :value="old('precio_producto')" required />
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
            <div class="form-group has-primary">
            <x-jet-label for="precio_producto" value="{{ __('Unidades de Venta del Producto') }}" />
            <x-jet-input id="precio_producto" class="form-control" type="text" name="precio_producto" maxlength="50" :value="old('precio_producto')" required />
            </div>
        </div>
    </div>
...
<div class="col-lg-12 left">
    <div class="row">
        <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12 left">
            <div class="form-group has-primary">
            <x-jet-label for="descripcion_producto" value="{{ __('Descripción de la Venta') }}" />

...
<P></P>
<p>En esta parte usted puede editar el proveedor registrado de la Fosforera Centroamericana.</p>
<P></P>
...
<div class="col-lg-12 left">
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
            ...
            <x-jet-input id="nombre_proveedor" class="form-control" type="text" style="text-transform:uppercase;" name="nombre_proveedor" maxlength="50" value="{{$proveedor->nombre_proveedor}}" />
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            ...
            <x-jet-input id="telefono_proveedor" class="form-control" type="text" style="text-transform:uppercase;" name="telefono_proveedor" maxlength="50" value="{{$proveedor->telefono_proveedor}}" />
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            ...
            <x-jet-input id="correo_proveedor" class="form-control" type="email" style="text-transform:uppercase;" name="correo_proveedor" maxlength="50" value="{{$proveedor->correo_proveedor}}" />
...
<div class="col-lg-12 left">
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 left">
            ...
            <x-jet-input id="rtn_proveedor" class="form-control" type="text"  required="" pattern="[0-9]+" style="text-transform:uppercase;" name="rtn_proveedor" maxlength="50" value="{{$proveedor->rtn_proveedor}}" />
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            ...
            <x-jet-input id="identidad_proveedor" class="form-control" type="text" style="text-transform:uppercase;" name="identidad_proveedor" maxlength="50" value="{{$proveedor->identidad_proveedor}}"/>
...
<div class="col-lg-12 left">
    <div class="row">
        <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12">
            ...
            <x-jet-input id="direccion_proveedor" class="form-control" type="text" style="text-transform:uppercase;" name="direccion_proveedor" maxlength="50" value="{{$proveedor->direccion_proveedor}}" />
...
<div class="col-lg-12 left">
    <div class="row">
        <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12">
            ...
            <x-jet-input id="descripcion_proveedor" class="form-control" type="text" style="text-transform:uppercase;" name="descripcion_proveedor" maxlength="50" value="{{$proveedor->descripcion_proveedor}}"/>
